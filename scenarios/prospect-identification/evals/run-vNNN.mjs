// TEMPLATE — copy this file and replace all instances of vNNN with the actual version (e.g., v002)
...
const PROMPT_FILE = join(BASE, 'prompts/vNNN.md');
const GT_DIR = join(BASE, 'ground-truth');
const OUT_FILE = join(BASE, 'evals/vNNN-raw.json');
