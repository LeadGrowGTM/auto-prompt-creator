// TEMPLATE — copy this file and replace all instances of v002 with the actual version (e.g., v002)
...
const PROMPT_FILE = join(BASE, 'prompts/v002.md');
const GT_DIR = join(BASE, 'ground-truth');
const OUT_FILE = join(BASE, 'evals/v002-raw.json');
